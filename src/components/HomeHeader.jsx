...
export default function HomeHeader() {
  ...
  return (
    <header id="header" className={scrolled ? 'effHeader' : ''}>
      ...
      <ul>
        <li id="header-menu" className={`clfeatured ${activeNav === 'featured' ? 'border' : ''}`}>
          <a href="#featured">Featured</a>
        </li>
        <li id="header-menu" className={`clnews ${activeNav === 'news' ? 'border' : ''}`}>
          <a href="#news">News</a>
        </li>
        <li id="header-menu" className={`clsongs ${activeNav === 'songs' ? 'border' : ''}`}>
      ...
      <label htmlFor="hamburger" id="hamburger-label" onClick={toggle}>
        <i className="fa-solid fa-bars-staggered" id="bars-icon" style={iconStyle}></i>
      </label>

      <div className="bars" style={barsStyle}>
        <ul id="head-bars">
          <li className="clfeatured"><a href="#featured">Featured</a></li>
          <li className="clnews"><a href="#news">News</a></li>
          <li className="clsongs"><a href="#songs">Songs</a></li>
        </ul>
