  ...
  return (
    <header id="header">
      ...
      <div className="bars" style={barsStyle}>
        <ul id="head-bars">
          <li id="header-menu" className="clfeatured"><a href="#featured">Featured</a></li>
          <li id="header-menu" className="clnews"><a href="#news">News</a></li>
          <li id="header-menu" className="clsongs"><a href="#songs">Songs</a></li>
